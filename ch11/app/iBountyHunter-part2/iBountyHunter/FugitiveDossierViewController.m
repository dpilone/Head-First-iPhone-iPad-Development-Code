...
- (NSString *) prepareMapDescription {
    return [NSString stringWithFormat: @"Last Seen: %6.3f,%6.3f\r\nDescription: %@",
...
- (void) updateDossier {
    ...
    mapDescription_.text = [self prepareMapDescription];
    
    CLLocationCoordinate2D mapCenter = CLLocationCoordinate2DMake([fugitive_.lastSeenLat doubleValue], 
                                                                  [fugitive_.lastSeenLon doubleValue]);      
