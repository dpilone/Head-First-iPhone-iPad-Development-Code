...
@interface iBountyHunterAppDelegate (Private)
...
{
    // Since multitasking saving should really be added to backgrounding notifications.
    [self saveContext];
}
...
- (void) createEditableCopyOfDatabaseIfNeeded {
    ...
    NSURL *writableDBPath = [documentsDir URLByAppendingPathComponent:@"iBountyHunter.sqlite"];
